...
def main():
    ...
    while True:
        ...
        if choice == "0":
            ...
            if rrt_path is None or astar_path is None:
                print("Unable to compare times - one of the algorithms failed to find a path")
            else:
            ...
            if rrtstar_path is None or astar_path is None:
                print("Unable to compare times - one of the algorithms failed to find a path")
            else:
            ...
            if rrt_path is None or rrtstar_path is None:
                print("Unable to compare times - one of the algorithms failed to find a path")
            else:
            ...
            if astar_path is None or rrt_path is None or rrtstar_path is None:
                print("Unable to compare times - one of the algorithms failed to find a path")
            else:
